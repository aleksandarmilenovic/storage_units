<div class="itemTypes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('opipljiv_tip'); ?></th>
			<th><?php echo $this->Paginator->sort('aktivan_tip'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($itemType['ItemType']['opipljiv_tip']); ?>&nbsp;</td>
		<td><?php echo h($itemType['ItemType']['aktivan_tip']); ?>&nbsp;</td>
